...
namespace WCFArchitect.Interface.Project.Host
{
	...
	public class PrincipalPermissionModeConverter : IValueConverter
	{
		...
		{
			System.ServiceModel.Description.PrincipalPermissionMode lt = (System.ServiceModel.Description.PrincipalPermissionMode)value;
	...
	public class X509CertificateValidationModeConverter : IValueConverter
	{
		public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
		{
			System.ServiceModel.Security.X509CertificateValidationMode lt = (System.ServiceModel.Security.X509CertificateValidationMode)value;
	...
	public class X509RevocationModeConverter : IValueConverter
	{
		public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
		{
			System.Security.Cryptography.X509Certificates.X509RevocationMode lt = (System.Security.Cryptography.X509Certificates.X509RevocationMode)value;
	...
	public class StoreLocationConverter : IValueConverter
	{
		public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
		{
			System.Security.Cryptography.X509Certificates.StoreLocation lt = (System.Security.Cryptography.X509Certificates.StoreLocation)value;
	...
	public class UserNamePasswordValidationModeConverter : IValueConverter
	{
		public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
		{
			System.ServiceModel.Security.UserNamePasswordValidationMode lt = (System.ServiceModel.Security.UserNamePasswordValidationMode)value;
	...
	public class HostEndpointIdentityTypeConverter : IValueConverter
	{
		public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
		{
			Projects.HostEndpointIdentityType lt = (Projects.HostEndpointIdentityType)value;

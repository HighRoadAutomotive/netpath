...
{
	[ValueConversion(typeof(Projects.RestSerialization), typeof(int))]
	public class RestSerializationConverter : IValueConverter
	{
		public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
		{
			var lt = (Projects.RestSerialization)value;
			if (lt == Projects.RestSerialization.Json) return 0;
			if (lt == Projects.RestSerialization.Bson) return 1;
			if (lt == Projects.RestSerialization.Xml) return 2;
			return 0;
		}
		...
		{
			var lt = (int)value;
			if (lt == 0) return Projects.RestSerialization.Json;
			if (lt == 1) return Projects.RestSerialization.Bson;
			if (lt == 2) return Projects.RestSerialization.Xml;
			return Projects.RestSerialization.Json;
		}
	}

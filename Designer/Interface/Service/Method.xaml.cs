...
namespace NETPath.Interface.Service
{
	...
	{
		public Projects.Method MethodData { get { return (Projects.Method)GetValue(MethodDataProperty); } set { SetValue(MethodDataProperty, value); } }
		public static readonly DependencyProperty MethodDataProperty = DependencyProperty.Register("MethodData", typeof(Projects.Method), typeof(Method));
		...
		public Method(Projects.Method Data)
		{
			MethodData = Data;
		...
		private void ValuesList_DragLeave(object sender, DragEventArgs e)
		{
			...
			foreach (Projects.MethodParameter O in MethodData.Parameters)
			{
		...
		private void Initiating_Checked(object sender, RoutedEventArgs e)
		{
			MethodData.IsTerminating = false;
		}

		private void Terminating_Checked(object sender, RoutedEventArgs e)
		{
			MethodData.IsInitiating = false;
		}

...
namespace WCFArchitect.Compiler.Generators
{
	internal static class DataCSGenerator
	{
		public static void VerifyCode(Data o)
		{
			...
			if (Program.Experimental && !o.HasAutoDataID)
			{
				Program.AddMessage(new CompileMessage("GS3003", "The data object '" + o.Name + "' in the '" + o.Parent.Name + "' namespace does not have an Automatic Data ID specified. A default ID will be used.", CompileMessageSeverity.WARN, o.Parent, o, o.GetType(), o.Parent.ID, o.ID));
		...
		public static string GenerateProxyAutoDataCode(Data o)
		{
			...
			if (Globals.CurrentGenerationTarget == ProjectGenerationFramework.NET30 || Globals.CurrentGenerationTarget == ProjectGenerationFramework.NET35 || Globals.CurrentGenerationTarget == ProjectGenerationFramework.NET35Client)
			{
				...
				code.AppendLine(string.Format("\t\tprivate static readonly System.Collections.Generic.Dictionary<Guid, {0}> __autodata;", DataTypeCSGenerator.GenerateType(o.HasClientType ? o.ClientType : o)));
				code.AppendLine(string.Format("\t\tstatic {0}()", o.HasClientType ? o.ClientType.Name : o.Name));
				code.AppendLine("\t\t{");
				code.AppendLine(string.Format("\t\t\t__autodata = new System.Collections.Generic.Dictionary<Guid, {0}>();", DataTypeCSGenerator.GenerateType(o.HasClientType ? o.ClientType : o)));
				code.AppendLine("\t\t}");
		...
		public static string GenerateXAMLCode45(Data o)
		{
			...
			code.AppendLine("\t\t//Automatic Data Update Support");
			code.AppendLine(GenerateXAMLAutoDataCode(o));
		...
		public static string GenerateXAMLAutoDataCode(Data o)
		{
			if (!Program.Experimental) return "";
			if (!o.AutoDataEnabled) return "";
			...
			{
				code.AppendLine(Globals.CurrentGenerationTarget == ProjectGenerationFramework.NET30 ? "\t\tprivate readonly System.Threading.ReaderWriterLock __autodatalock = new System.Threading.ReaderWriterLock();" : "\t\tprivate readonly System.Threading.ReaderWriterLockSlim __autodatalock = new System.Threading.ReaderWriterLockSlim();");
				code.AppendLine(string.Format("\t\tprivate static readonly System.Collections.Generic.Dictionary<Guid, {0}> __autodata;", DataTypeCSGenerator.GenerateType(o.XAMLType)));
				code.AppendLine(string.Format("\t\tstatic {0}()", o.XAMLType.Name));
				code.AppendLine("\t\t{");
				code.AppendLine(string.Format("\t\t\t__autodata = new System.Collections.Generic.Dictionary<Guid, {0}>();", DataTypeCSGenerator.GenerateType(o.XAMLType)));
				code.AppendLine("\t\t}");
				code.AppendLine("\t\t[OnDeserialized]");
				code.AppendLine("\t\tprivate void OnDeserialized(StreamingContext context)");
				code.AppendLine("\t\t{");
				code.AppendLine(string.Format("\t\t\tlock(((ICollection)__autodata).SyncRoot) {{ __autodata.Add({0}, this); }}", o.AutoDataID.XAMLName));
				code.AppendLine("\t\t}");
				code.AppendLine(string.Format("\t\t~{0}()", o.XAMLType.Name));
				code.AppendLine("\t\t{");
				code.AppendLine(string.Format("\t\t\t{0} t;", DataTypeCSGenerator.GenerateType(o.XAMLType)));
				code.AppendLine(string.Format("\t\t\tlock(((ICollection)__autodata).SyncRoot) {{ __autodata.Remove({0}, out t); }}", o.AutoDataID.XAMLName));
				code.AppendLine("\t\t}");
			}
			else
			{
				code.AppendLine("\t\tprivate readonly System.Threading.ReaderWriterLockSlim __autodatalock = new System.Threading.ReaderWriterLockSlim();");
				code.AppendLine(string.Format("\t\tprivate static readonly System.Collections.Concurrent.ConcurrentDictionary<Guid, {0}> __autodata;", DataTypeCSGenerator.GenerateType(o.XAMLType)));
				code.AppendLine(string.Format("\t\tstatic {0}()", o.XAMLType.Name));
				code.AppendLine("\t\t{");
				code.AppendLine(string.Format("\t\t\t__autodata = new System.Collections.Concurrent.ConcurrentDictionary<Guid, {0}>();", DataTypeCSGenerator.GenerateType(o.XAMLType)));
				code.AppendLine("\t\t}");
				code.AppendLine("\t\t[OnDeserialized]");
				code.AppendLine("\t\tprivate void OnDeserialized(StreamingContext context)");
				code.AppendLine("\t\t{");
				code.AppendLine(string.Format("\t\t\t__autodata.TryAdd({0}, this);", o.AutoDataID.XAMLName));
				code.AppendLine("\t\t}");
				code.AppendLine(string.Format("\t\t~{0}()", o.XAMLType.Name));
				code.AppendLine("\t\t{");
				code.AppendLine(string.Format("\t\t\t{0} t;", DataTypeCSGenerator.GenerateType(o.XAMLType)));
				code.AppendLine(string.Format("\t\t\t__autodata.TryRemove({0}, out t);", o.AutoDataID.XAMLName));
				code.AppendLine("\t\t}");
			}
			return code.ToString();
		}
		...
		private static string GenerateElementProxyCode40(DataElement o)
		{
			...
			var code = new StringBuilder();
			if (Program.Experimental && o.AutoDataEnabled) code.AppendLine(string.Format("\t\tprivate bool {0}Changed;", o.HasClientType ? o.ClientName : o.DataName));
			code.AppendLine(string.Format("\t\tprivate {0} {1}Field;", DataTypeCSGenerator.GenerateType(o.HasClientType ? o.ClientType : o.DataType), o.HasClientType ? o.ClientName : o.DataName));
			if (o.Documentation != null) code.Append(DocumentationCSGenerator.GenerateDocumentation(o.Documentation));
			code.AppendFormat("\t\t[DataMember({0}{1}{2}Name = \"{3}\")] ", o.EmitDefaultValue ? "EmitDefaultValue = false, " : "", o.IsRequired ? "IsRequired = true, " : "", o.Order >= 0 ? string.Format("Order = {0}, ", o.Order) : "", o.HasClientType ? o.ClientName : o.DataName);
			if (Program.Experimental && o.AutoDataEnabled)
				if (Globals.CurrentGenerationTarget == ProjectGenerationFramework.NET30) code.AppendLine(string.Format("public {0} {1} {{ get {{ __autodatalock.{4}; try {{ return {1}Field; }} finally {{ __autodatalock.ReleaseReaderLock(); }} }} {2}set {{ __autodatalock.{5}; try {{ {1}Field = value; {1}Changed = true; {3}}} finally {{ __autodatalock.ReleaseWriterLock(); }} }} }}", DataTypeCSGenerator.GenerateType(o.HasClientType ? o.ClientType : o.DataType), o.HasClientType ? o.ClientName : o.DataName, o.IsReadOnly ? "protected " : "", o.GenerateWinFormsSupport ? "NotifyPropertyChanged(); " : "", string.Format("AcquireReaderLock({0})", o.AutoDataTimeout), string.Format("AcquireWriterLock({0})", o.AutoDataTimeout)));
				else code.AppendLine(string.Format("public {0} {1} {{ get {{ __autodatalock.{4}; try {{ return {1}Field; }} finally {{ __autodatalock.ExitReadLock(); }} }} {2}set {{ __autodatalock.{5}; try {{ {1}Field = value; {1}Changed = true; {3}}} finally {{ __autodatalock.ExitWriteLock(); }} }} }}", DataTypeCSGenerator.GenerateType(o.HasClientType ? o.ClientType : o.DataType), o.HasClientType ? o.ClientName : o.DataName, o.IsReadOnly ? "protected " : "", o.GenerateWinFormsSupport ? "NotifyPropertyChanged(); " : "", o.AutoDataTimeout == 0 ? "EnterReadLock()" : string.Format("TryEnterReadLock({0})", o.AutoDataTimeout), o.AutoDataTimeout == 0 ? "EnterWriteLock()" : string.Format("TryEnterWriteLock({0})", o.AutoDataTimeout)));
			else
				code.AppendLine(string.Format("public {0} {1} {{ get {{ return {1}Field; }} {2}set {{ {1}Field = value; {3}}} }}", DataTypeCSGenerator.GenerateType(o.HasClientType ? o.ClientType : o.DataType), o.HasClientType ? o.ClientName : o.DataName, o.IsReadOnly ? "protected " : "", o.GenerateWinFormsSupport ? string.Format("NotifyPropertyChanged(\"{0}\"); ", o.HasClientType ? o.ClientName : o.DataName) : ""));
			return code.ToString();
		}
		...
		private static string GenerateElementProxyCode45(DataElement o)
		{
			...
			code.AppendFormat("\t\t[DataMember({0}{1}{2}Name = \"{3}\")] ", o.EmitDefaultValue ? "EmitDefaultValue = false, " : "", o.IsRequired ? "IsRequired = true, " : "", o.Order >= 0 ? string.Format("Order = {0}, ", o.Order) : "", o.HasClientType ? o.ClientName : o.DataName);
			if (Program.Experimental && o.AutoDataEnabled)
				code.AppendLine(string.Format("public {0} {1} {{ get {{ __autodatalock.{4}; try {{ return {1}Field; }} finally {{ __autodatalock.ExitReadLock(); }} }} {2}set {{ __autodatalock.{5}; try {{ {1}Field = value; {1}Changed = true; {3}}} finally {{ __autodatalock.ExitWriteLock(); }} }} }}", DataTypeCSGenerator.GenerateType(o.HasClientType ? o.ClientType : o.DataType), o.HasClientType ? o.ClientName : o.DataName, o.IsReadOnly ? "protected " : "", o.GenerateWinFormsSupport ? "NotifyPropertyChanged(); " : "", o.AutoDataTimeout == 0 ? "EnterReadLock()" : string.Format("TryEnterReadLock({0})", o.AutoDataTimeout), o.AutoDataTimeout == 0 ? "EnterWriteLock()" : string.Format("TryEnterWriteLock({0})", o.AutoDataTimeout)));
			else
				code.AppendLine(string.Format("public {0} {1} {{ get {{ return {1}Field; }} {2}set {{ {1}Field = value; {3}}} }}", DataTypeCSGenerator.GenerateType(o.HasClientType ? o.ClientType : o.DataType), o.HasClientType ? o.ClientName : o.DataName, o.IsReadOnly ? "protected " : "", o.GenerateWinFormsSupport ? "NotifyPropertyChanged(); " : ""));
			return code.ToString();
		}
		...
		private static string GenerateElementXAMLCode45(DataElement o)
		{
			...
			var code = new StringBuilder();
			if (Program.Experimental && o.AutoDataEnabled) code.AppendLine(string.Format("\t\tprivate int {0}Changed;", o.XAMLName));
			if (o.Documentation != null) code.Append(DocumentationCSGenerator.GenerateDocumentation(o.Documentation));

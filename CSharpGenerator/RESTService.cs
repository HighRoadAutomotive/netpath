...
namespace NETPath.Generators.CS
{
	internal static class RESTServiceGenerator
	{
		...
		public static string GenerateServiceInterfaceMethod(RESTMethod o)
		{
			...
			code.AppendFormat("\t\t{0} {1}(", o.ServerAsync ? string.Format("Task<{0}>", DataTypeGenerator.GenerateType(o.ReturnType)) : DataTypeGenerator.GenerateType(o.ReturnType), o.ServerName);
		...
		public static string GenerateServerProxyMethod(RESTMethod o)
		{
			if (o.IsHidden) return "";
			var code = new StringBuilder();
			code.AppendFormat("\t\tpublic abstract {0} {1}(", o.ServerAsync ? string.Format("async Task<{0}>", DataTypeGenerator.GenerateType(o.ReturnType)) : DataTypeGenerator.GenerateType(o.ReturnType), o.ServerName);
			foreach (RESTMethodParameter op in o.Parameters)

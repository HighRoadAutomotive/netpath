...
namespace System.Collections.Generic
{
	...
	public class DeltaDictionary<TKey, TValue> : IDictionary<TKey, TValue>
	{
		...
		[IgnoreDataMember, XmlIgnore] private ConcurrentDictionary<TKey, TValue> il;
		[IgnoreDataMember, XmlIgnore] private ConcurrentQueue<ChangeDictionaryItem<TKey, TValue>> dl;

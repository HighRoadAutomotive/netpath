...
namespace System.Collections.Generic
{
	...
	public class DependencyDictionary<TKey, TValue> : IDictionary<TKey, TValue>
	{
		...
		private void CallAdded(TKey key, TValue value)
		{
			...
			else Application.Current.Dispatcher.Invoke(new Action(() => { if (Added != null) Added(key, value); }), DispatcherPriority.Normal);
		}
		...
		private void CallRemoved(TKey key, TValue value)
		{
			...
			else Application.Current.Dispatcher.Invoke(new Action(() => { if (Removed != null) Removed(key, value); }), DispatcherPriority.Normal);
		}
		...
		private void CallCleared(KeyValuePair<TKey, TValue>[] values)
		{
			...
			else Application.Current.Dispatcher.Invoke(new Action(() => { if (Cleared != null) Cleared(values); }), DispatcherPriority.Normal);
		}
		...
		private void CallUpdated(TKey index, TValue olditem, TValue newitem)
		{
			...
			else Application.Current.Dispatcher.Invoke(new Action(() => { if (Updated != null) Updated(index, olditem, newitem); }), DispatcherPriority.Normal);
		}

...
namespace NETPath.Generators.CS.WebApi
{
	internal static class DataGenerator
	{
		...
		{
			var code = new StringBuilder();
			code.AppendLine(string.Format("\t\t[DataMember(Name = \"{0}\"{1}{2}{3}{4})]", o.HasClientType ? o.ClientName : o.DataName, o.IsRequired ? ", IsRequired = true" : ", IsRequired = false", o.EmitDefaultValue ? ", EmitDefaultValue = false" : "", o.Order >= 0 ? string.Format(", Order = {0}{1}", o.Order, o.HasContractName ? ", " : "") : "", o.HasContractName ? string.Format(", Name = \"{0}\"", o.ContractName) : ""));

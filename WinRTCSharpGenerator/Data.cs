...
namespace NETPath.Generators.WinRT.CS
{
	internal static class DataGenerator
	{
		...
		public static string GenerateProxyCodeRT8(Data o)
		{
			...
			code.AppendLine(string.Format("\t{0}", DataTypeGenerator.GenerateTypeDeclaration(o.HasClientType ? o.ClientType : o, false, o.HasWinFormsBindings, o.AutoDataEnabled, o.AutoDataEnabled)));
			code.AppendLine("\t{");
			if (o.HasXAMLType)
			{
		...
		private static string GenerateElementXAMLCodeRT8(DataElement o)
		{
			...
			if (o.IsAttached)
			{
				...
				code.AppendLine(string.Format("\t\tpublic static {0} Get{1}(DependencyObject obj) {{ return ({0})obj.GetValue({1}Property); }}", DataTypeGenerator.GenerateType(GetPreferredXAMLType(o.XAMLType, o.Owner.AutoDataEnabled && o.AutoDataEnabled)), o.XAMLName));
				code.AppendLine(string.Format("\t\tpublic static void Set{1}(DependencyObject obj, {0} value) {{ obj.SetValue({1}Property, value); }}", DataTypeGenerator.GenerateType(GetPreferredXAMLType(o.XAMLType, o.Owner.AutoDataEnabled && o.AutoDataEnabled)), o.XAMLName));
				code.Append(GenerateElementXAMLDPCode45(o));
			}
			else
			{
				code.AppendLine(string.Format("\t\tpublic {0} {1} {{ get {{ return ({0})GetValue({1}Property); }} {2}set {{ SetValue({1}Property, value); }} }}", DataTypeGenerator.GenerateType(GetPreferredXAMLType(o.XAMLType, o.Owner.AutoDataEnabled && o.AutoDataEnabled)), o.XAMLName, o.IsReadOnly ? "protected " : ""));
				code.Append(GenerateElementXAMLDPCode45(o));
			}
			return code.ToString();
		}
		...
		private static string GenerateElementXAMLDPCode45(DataElement o)
		{
			...
			if (o.Owner.AutoDataEnabled && o.AutoDataEnabled)
			{
				if (o.XAMLType.TypeMode == DataTypeMode.Collection)
				{
					code.AppendLine(string.Format("\t\tprivate static readonly PropertyMetadata {0}PropertyMetadata = new PropertyMetadata(default(DependencyList<{2}>), (o, e) => {{ var t = o as {1}; var nl = e.NewValue as DependencyList<{2}>; var ol = e.OldValue as DependencyList<{2}>; if (t == null || nl == null || ol == null) return; ", o.XAMLName, o.Owner.XAMLType.Name, DataTypeGenerator.GenerateType(GetPreferredXAMLType(o.XAMLType.CollectionGenericType))));
				...
				{
					code.AppendLine(string.Format("\t\tprivate static readonly PropertyMetadata {0}PropertyMetadata = new PropertyMetadata(default({1}), (o, e) => {{ var t = o as {3}; if (t == null) return; t.DataObject.{2} = ({1})e.NewValue; t.{0}PropertyChanged(({1})e.NewValue, ({1})e.OldValue); }});", o.XAMLName, DataTypeGenerator.GenerateType(GetPreferredXAMLType(o.XAMLType, o.AutoDataEnabled)), o.HasClientType ? o.ClientName : o.DataName, o.Owner.XAMLType.Name));
			...
			code.AppendLine(string.Format("\t\tpublic static readonly DependencyProperty {1}Property = DependencyProperty.Register{4}(\"{1}\", typeof({0}), typeof({2}){3});", DataTypeGenerator.GenerateType(GetPreferredXAMLType(o.XAMLType, o.AutoDataEnabled)), o.XAMLName, o.Owner.XAMLType.Name, o.Owner.AutoDataEnabled && o.AutoDataEnabled ? string.Format(", {0}PropertyMetadata", o.XAMLName) : ", null", o.IsAttached ? "Attached" : ""));

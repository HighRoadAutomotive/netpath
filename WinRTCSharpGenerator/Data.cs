	...
	internal static class DataGenerator
	{
		...
		public static string GenerateProxyCodeRT8(Data o)
		{
			...
			if (o.HasXAMLType)
			{
				...
				code.AppendLine(string.Format("\t\tpublic {0} XAMLObject {{ get {{ if(xamlObject == null) Window.Current.Dispatcher.RunAsync(CoreDispatcherPriority.Normal, () => {{ xamlObject = new {0}(this); }}); return xamlObject; }} private set {{ xamlObject = value; }} }}", o.XAMLType.Name));
				code.AppendLine();
			}
			code.Append(GenerateProxyDCMCode(o));
			...
			code.AppendLine("\t\t{");
			if (o.HasXAMLType) code.AppendLine(string.Format("\t\t\tWindow.Current.Dispatcher.RunAsync(CoreDispatcherPriority.Normal, () => {{ XAMLObject = new {0}(this); }});", o.XAMLType.Name));
			foreach (DataElement de in o.Elements)
		...
		private static string GenerateElementXAMLCodeRT8(DataElement o)
		{
			...
			if (o.IsAttached)
			{
				...
				code.AppendLine(string.Format("\t\tpublic static {0} Get{1}(DependencyObject obj) {{ return ({0})obj.GetValue({1}Property); }}", DataTypeGenerator.GenerateType(GetPreferredXAMLType(o.XAMLType, o.Owner.CMDEnabled && o.DCMEnabled)), o.XAMLName));
				code.AppendLine(string.Format("\t\tpublic static void Set{1}(DependencyObject obj, {0} value) {{ obj.SetValue({1}Property, value); }}", DataTypeGenerator.GenerateType(GetPreferredXAMLType(o.XAMLType, o.Owner.CMDEnabled && o.DCMEnabled)), o.XAMLName));
				code.Append(GenerateElementXAMLDPCode45(o));
			}
			else
			{
				code.AppendLine(string.Format("\t\tpublic {0} {1} {{ get {{ return ({0})GetValue({1}Property); }} {2}set {{ SetValue({1}Property, value); }} }}", DataTypeGenerator.GenerateType(GetPreferredXAMLType(o.XAMLType, o.Owner.CMDEnabled && o.DCMEnabled)), o.XAMLName, o.IsReadOnly ? "protected " : ""));
				code.Append(GenerateElementXAMLDPCode45(o));
			}
			return code.ToString();
		}
		...
		private static string GenerateElementXAMLDPCode45(DataElement o)
		{
			...
			if (o.Owner.CMDEnabled && o.DCMEnabled)
			{
				...
				{
					code.AppendLine(string.Format("\t\tprivate static readonly PropertyMetadata {0}PropertyMetadata = new PropertyMetadata(default({1}), (o, e) => {{ var t = o as {3}; var nv = e.NewValue as {1}; if (t == null || nv == null) return; var z = new {4}[nv.Length]; for (int i = 0; i < nv.Length; i++) z[i] = nv[i]; t.DataObject.{2} = z;  t.{0}PropertyChanged(({1})e.NewValue, ({1})e.OldValue); }});", o.XAMLName, DataTypeGenerator.GenerateType(GetPreferredXAMLType(o.XAMLType, o.DCMEnabled)), o.HasClientType ? o.ClientName : o.DataName, o.Owner.XAMLType.Name, o.HasClientType ? o.ClientType.CollectionGenericType : o.DataType.CollectionGenericType));
				...
				{
					code.AppendLine(string.Format("\t\tprivate static readonly PropertyMetadata {0}PropertyMetadata = new PropertyMetadata(default({1}), (o, e) => {{ var t = o as {3}; if (t == null) return; t.DataObject.{2} = ({1})e.NewValue; t.{0}PropertyChanged(({1})e.NewValue, ({1})e.OldValue); }});", o.XAMLName, DataTypeGenerator.GenerateType(GetPreferredXAMLType(o.XAMLType, o.DCMEnabled)), o.HasClientType ? o.ClientName : o.DataName, o.Owner.XAMLType.Name));
					code.AppendLine(string.Format("\t\tpartial void {0}PropertyChanged({1} OldValue, {1} NewValue);", o.XAMLName, DataTypeGenerator.GenerateType(GetPreferredXAMLType(o.XAMLType, o.DCMEnabled))));
				}
			}

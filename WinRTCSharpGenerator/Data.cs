	...
	internal static class DataGenerator
	{
		...
		private static string GenerateElementServerCode45(DataElement o, ref int ProtoCount)
		{
			...
			if (o.IsDataMember)
			{
				...
				else code.AppendFormat("[DataMember({0}{1}{2}{3})] ", o.EmitDefaultValue ? "EmitDefaultValue = false, " : "", o.IsRequired ? "IsRequired = true, " : "", o.ProtocolBufferEnabled ? string.Format("Order = {0}, ", ProtoCount) : o.Order >= 0 ? string.Format("Order = {0}, ", o.Order) : "", o.HasContractName ? string.Format("Name = \"{0}\"", o.ContractName) : "");
			}
			else

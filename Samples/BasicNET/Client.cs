...
{
	[System.CodeDom.Compiler.GeneratedCodeAttribute("NETPath .NET CSharp Generator - BETA", "2.0.0.1362")]
...
namespace WCFArchitect.SampleServer.BasicWinRT
{
	...
	public partial class CustomerXAML : DependencyObjectEx
	{
		...
		public static readonly DependencyProperty IDProperty = DependencyProperty.Register("ID", typeof(Guid), typeof(CustomerXAML), new PropertyMetadata((o, e) => { var t = o as CustomerXAML; if (t == null) return; t.DataObject.ID = (Guid)e.NewValue; t.IDPropertyChanged((Guid)e.NewValue, (Guid)e.OldValue); }));
		...
		public static readonly DependencyProperty NameProperty = DependencyProperty.Register("Name", typeof(string), typeof(CustomerXAML), new PropertyMetadata((o, e) => { var t = o as CustomerXAML; if (t == null) return; t.DataObject.Name = (string)e.NewValue; t.NamePropertyChanged((string)e.NewValue, (string)e.OldValue); }));
		...
		public static readonly DependencyProperty CityProperty = DependencyProperty.Register("City", typeof(string), typeof(CustomerXAML), new PropertyMetadata((o, e) => { var t = o as CustomerXAML; if (t == null) return; t.DataObject.City = (string)e.NewValue; t.CityPropertyChanged((string)e.NewValue, (string)e.OldValue); }));
		...
		public static readonly DependencyProperty ListTestProperty = DependencyProperty.Register("ListTest", typeof(DependencyList<WCFArchitect.SampleServer.BasicWinRT.CustomerXAML>), typeof(CustomerXAML), new PropertyMetadata((o, e) => { var t = o as CustomerXAML; if (t == null) return; t.DataObject.ListTest = (DependencyList<WCFArchitect.SampleServer.BasicWinRT.CustomerXAML>)e.NewValue; t.ListTestPropertyChanged((DependencyList<WCFArchitect.SampleServer.BasicWinRT.CustomerXAML>)e.NewValue, (DependencyList<WCFArchitect.SampleServer.BasicWinRT.CustomerXAML>)e.OldValue); }));
		partial void ListTestPropertyChanged(DependencyList<WCFArchitect.SampleServer.BasicWinRT.CustomerXAML> OldValue, DependencyList<WCFArchitect.SampleServer.BasicWinRT.CustomerXAML> NewValue);

...
namespace WCFArchitect.SampleServer.BasicWinRT
{
	...
	**************************************************************************/
	...
	[System.CodeDom.Compiler.GeneratedCodeAttribute("NETPath WinRT CSharp Generator - BETA", "2.0.0.1372")]
	...
	**************************************************************************/
	...
	public partial class CustomerXAML : DependencyObjectEx
	{
		...
		private static readonly PropertyMetadata IDPropertyMetadata = new PropertyMetadata(default(Guid), (o, e) => { var t = o as CustomerXAML; if (t == null) return; t.DataObject.ID = (Guid)e.NewValue; t.IDPropertyChanged((Guid)e.NewValue, (Guid)e.OldValue); });
		partial void IDPropertyChanged(Guid OldValue, Guid NewValue);
		...
		private static readonly PropertyMetadata NamePropertyMetadata = new PropertyMetadata(default(string), (o, e) => { var t = o as CustomerXAML; if (t == null) return; t.DataObject.Name = (string)e.NewValue; t.NamePropertyChanged((string)e.NewValue, (string)e.OldValue); });
		partial void NamePropertyChanged(string OldValue, string NewValue);
		...
		private static readonly PropertyMetadata CityPropertyMetadata = new PropertyMetadata(default(string), (o, e) => { var t = o as CustomerXAML; if (t == null) return; t.DataObject.City = (string)e.NewValue; t.CityPropertyChanged((string)e.NewValue, (string)e.OldValue); });
		partial void CityPropertyChanged(string OldValue, string NewValue);
		...
		private static readonly PropertyMetadata ListTestPropertyMetadata = new PropertyMetadata(default(DependencyList<WCFArchitect.SampleServer.BasicWinRT.CustomerXAML>), (o, e) => { var t = o as CustomerXAML; var nl = e.NewValue as DependencyList<WCFArchitect.SampleServer.BasicWinRT.CustomerXAML>; var ol = e.OldValue as DependencyList<WCFArchitect.SampleServer.BasicWinRT.CustomerXAML>; if (t == null || nl == null || ol == null) return; 
		...
		private static readonly PropertyMetadata DictionaryTestPropertyMetadata = new PropertyMetadata(default(DependencyDictionary<Guid, WCFArchitect.SampleServer.BasicWinRT.CustomerXAML>), (o, e) => { var t = o as CustomerXAML; var nl = e.NewValue as DependencyDictionary<Guid, WCFArchitect.SampleServer.BasicWinRT.CustomerXAML>; var ol = e.OldValue as DependencyDictionary<Guid, WCFArchitect.SampleServer.BasicWinRT.CustomerXAML>; if (t == null || nl == null || ol == null) return; 

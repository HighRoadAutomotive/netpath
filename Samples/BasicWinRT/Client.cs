...
namespace WCFArchitect.SampleServer.BasicWinRT
{
	...
	**************************************************************************/
	...
	[System.CodeDom.Compiler.GeneratedCodeAttribute("NETPath WinRT CSharp Generator - BETA", "2.0.0.12513")]
	...
	**************************************************************************/
	...
	public partial class Customer
	{
		...
		[ProtoBuf.ProtoMember(5, IsPacked = true, OverwriteList = true, AsReference = true, DynamicType = true)]  [DataMember(Order = 5, Name = "State")] public string State { get { return StateField; } set { StateField = value; } }
		private int ZipCodeField;
		[ProtoBuf.ProtoMember(6, OverwriteList = true)]  [DataMember(Order = 6, Name = "ZipCode")] public int ZipCode { get { return ZipCodeField; } set { ZipCodeField = value; } }
		private WCFArchitect.SampleServer.BasicWinRT.Colors ColorField;
		[ProtoBuf.ProtoMember(7, OverwriteList = true)]  [DataMember(Order = 7, Name = "Color")] public WCFArchitect.SampleServer.BasicWinRT.Colors Color { get { return ColorField; } set { ColorField = value; } }
	}

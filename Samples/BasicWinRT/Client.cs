...
namespace WCFArchitect.SampleServer.BasicWinRT
{
	...
	**************************************************************************/
	...
	[System.CodeDom.Compiler.GeneratedCodeAttribute("NETPath WinRT CSharp Generator - BETA", "2.0.0.1364")]
	...
	**************************************************************************/
	...
	public partial class CustomerXAML : DependencyObjectEx
	{
		...
		public DependencyDictionary<Guid, WCFArchitect.SampleServer.BasicWinRT.CustomerXAML> DictionaryTest { get { return (DependencyDictionary<Guid, WCFArchitect.SampleServer.BasicWinRT.CustomerXAML>)GetValue(DictionaryTestProperty); } set { SetValue(DictionaryTestProperty, value); } }
		public static readonly DependencyProperty DictionaryTestProperty = DependencyProperty.Register("DictionaryTest", typeof(DependencyDictionary<Guid, WCFArchitect.SampleServer.BasicWinRT.CustomerXAML>), typeof(CustomerXAML), new PropertyMetadata(default(DependencyDictionary<Guid, WCFArchitect.SampleServer.BasicWinRT.CustomerXAML>), (o, e) => { var t = o as CustomerXAML; if (t == null) return; t.DataObject.DictionaryTest = (DependencyDictionary<Guid, WCFArchitect.SampleServer.BasicWinRT.CustomerXAML>)e.NewValue; t.DictionaryTestPropertyChanged((DependencyDictionary<Guid, WCFArchitect.SampleServer.BasicWinRT.CustomerXAML>)e.NewValue, (DependencyDictionary<Guid, WCFArchitect.SampleServer.BasicWinRT.CustomerXAML>)e.OldValue); }));
		partial void DictionaryTestPropertyChanged(System.Collections.Concurrent.ConcurrentDictionary<Guid, WCFArchitect.SampleServer.BasicWinRT.Customer> OldValue, System.Collections.Concurrent.ConcurrentDictionary<Guid, WCFArchitect.SampleServer.BasicWinRT.Customer> NewValue);

...
//
// WCF Architect Version:	2.0.0.12496
...
namespace WCFArchitect.SampleServer.BasicWinRT
{
	...
	**************************************************************************/
	...
	[System.CodeDom.Compiler.GeneratedCodeAttribute("WCF Architect WinRT CSharp Generator - BETA", "2.0.0.12496")]
	...
	**************************************************************************/
	...
	public partial class Customer
	{
		...
		private ObservableCollection<WCFArchitect.SampleServer.BasicWinRT.Customer> NestedCollectionField;
		[DataMember(Name = "NestedCollection")] public ObservableCollection<WCFArchitect.SampleServer.BasicWinRT.Customer> NestedCollection { get { return NestedCollectionField; } set { NestedCollectionField = value; } }
		private Dictionary<int, WCFArchitect.SampleServer.BasicWinRT.Customer> NestedDictionaryField;
		[DataMember(Name = "NestedDictionary")] public Dictionary<int, WCFArchitect.SampleServer.BasicWinRT.Customer> NestedDictionary { get { return NestedDictionaryField; } set { NestedDictionaryField = value; } }
	}
	...
	public partial class CustomerXAML : DependencyObject
	{
		...
		public ObservableCollection<WCFArchitect.SampleServer.BasicWinRT.CustomerXAML> NestedCollection { get { return (ObservableCollection<WCFArchitect.SampleServer.BasicWinRT.CustomerXAML>)GetValue(NestedCollectionProperty); } set { SetValue(NestedCollectionProperty, value); } }
		public static readonly DependencyProperty NestedCollectionProperty = DependencyProperty.Register("NestedCollection", typeof(ObservableCollection<WCFArchitect.SampleServer.BasicWinRT.CustomerXAML>), typeof(WCFArchitect.SampleServer.BasicWinRT.CustomerXAML), null);
		public Dictionary<int, WCFArchitect.SampleServer.BasicWinRT.CustomerXAML> NestedDictionary { get { return (Dictionary<int, WCFArchitect.SampleServer.BasicWinRT.CustomerXAML>)GetValue(NestedDictionaryProperty); } set { SetValue(NestedDictionaryProperty, value); } }
		public static readonly DependencyProperty NestedDictionaryProperty = DependencyProperty.Register("NestedDictionary", typeof(Dictionary<int, WCFArchitect.SampleServer.BasicWinRT.CustomerXAML>), typeof(WCFArchitect.SampleServer.BasicWinRT.CustomerXAML), null);
		...
		public CustomerXAML(WCFArchitect.SampleServer.BasicWinRT.Customer Data)
		{
			...
			Color = Data.Color;
			ObservableCollection<WCFArchitect.SampleServer.BasicWinRT.Customer> vNestedCollection = new ObservableCollection<WCFArchitect.SampleServer.BasicWinRT.Customer>();
			foreach(WCFArchitect.SampleServer.BasicWinRT.Customer a in Data.NestedCollection) { vNestedCollection.Add(a); }
			NestedCollection = vNestedCollection;
			Dictionary<int, WCFArchitect.SampleServer.BasicWinRT.Customer> vNestedDictionary = new Dictionary<int, WCFArchitect.SampleServer.BasicWinRT.Customer>();
			foreach(KeyValuePair<int, WCFArchitect.SampleServer.BasicWinRT.Customer> a in Data.NestedDictionary) { vNestedDictionary.Add(a.Key, a.Value); }
			NestedDictionary = vNestedDictionary;
		}
		...
		public static Customer ConvertFromXAMLObject(WCFArchitect.SampleServer.BasicWinRT.CustomerXAML Data)
		{
			...
			ObservableCollection<WCFArchitect.SampleServer.BasicWinRT.Customer> vNestedCollection = new ObservableCollection<WCFArchitect.SampleServer.BasicWinRT.Customer>();
			foreach(WCFArchitect.SampleServer.BasicWinRT.Customer a in Data.NestedCollection) { vNestedCollection.Add(a); }
			DTO.NestedCollection = vNestedCollection;
			Dictionary<int, WCFArchitect.SampleServer.BasicWinRT.Customer> vNestedDictionary = new Dictionary<int, WCFArchitect.SampleServer.BasicWinRT.Customer>();
			foreach(KeyValuePair<int, WCFArchitect.SampleServer.BasicWinRT.Customer> a in Data.NestedDictionary) { vNestedDictionary.Add(a.Key, a.Value); }
			DTO.NestedDictionary = vNestedDictionary;
			return DTO;
		}
		...
		public static CustomerXAML ConvertToXAMLObject(WCFArchitect.SampleServer.BasicWinRT.Customer Data)
		{
			...
			ObservableCollection<WCFArchitect.SampleServer.BasicWinRT.Customer> vNestedCollection = new ObservableCollection<WCFArchitect.SampleServer.BasicWinRT.Customer>();
			foreach(WCFArchitect.SampleServer.BasicWinRT.Customer a in Data.NestedCollection) { vNestedCollection.Add(a); }
			XAML.NestedCollection = vNestedCollection;
			Dictionary<int, WCFArchitect.SampleServer.BasicWinRT.Customer> vNestedDictionary = new Dictionary<int, WCFArchitect.SampleServer.BasicWinRT.Customer>();
			foreach(KeyValuePair<int, WCFArchitect.SampleServer.BasicWinRT.Customer> a in Data.NestedDictionary) { vNestedDictionary.Add(a.Key, a.Value); }
			XAML.NestedDictionary = vNestedDictionary;
			return XAML;
		}
	}

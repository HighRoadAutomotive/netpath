...
namespace System.Collections.Generic
{
	...
	public class DependencyDictionary<TKey, TValue> : IDictionary<TKey, TValue>
	{
		...
		private void CallAdded(TKey key, TValue value)
		{
			...
			else Application.Current.Dispatcher.Invoke(new Action(() => Added(key, value)), DispatcherPriority.Normal);
		}
		...
		private void CallRemoved(TKey key, TValue value)
		{
			...
			else Application.Current.Dispatcher.Invoke(new Action(() => Removed(key, value)), DispatcherPriority.Normal);
		}
		...
		private void CallCleared(KeyValuePair<TKey, TValue>[] values)
		{
			...
			else Application.Current.Dispatcher.Invoke(new Action(() => Cleared(values)), DispatcherPriority.Normal);
		}

	...
	internal static class NamespaceGenerator
	{
		...
		public static string GenerateClientCode30(Namespace o)
		{
			...
			if (o.Hosts.Count > 0)
			{
				...
				code.AppendLine();
				foreach (Host he in o.Hosts)
					code.AppendLine(HostGenerator.GenerateClientCode35(he));
				code.AppendLine();
			}
		...
		public static string GenerateClientCode35Client(Namespace o)
		{
			...
			if (o.Hosts.Count > 0)
			{
				...
				code.AppendLine();
				foreach (Host he in o.Hosts)
					code.AppendLine(HostGenerator.GenerateClientCode35Client(he));
				code.AppendLine();
			}
		...
		public static string GenerateClientCode40(Namespace o)
		{
			...
			if (o.Hosts.Count > 0)
			{
				...
				code.AppendLine();
				foreach (Host he in o.Hosts)
					code.AppendLine(HostGenerator.GenerateClientCode40(he));
				code.AppendLine();
			}
		...
		public static string GenerateClientCode40Client(Namespace o)
		{
			...
			if (o.Hosts.Count > 0)
			{
				...
				code.AppendLine();
				foreach (Host he in o.Hosts)
					code.AppendLine(HostGenerator.GenerateClientCode40Client(he));
				code.AppendLine();
			}

	...
	internal static class HostGenerator
	{
		...
		public static string GenerateEndpointClientCode(HostEndpoint o, bool IsDCMEnabled = false)
		{
			...
			else
			{
				...
				#region - Generate Endpoint Functions WITHOUT EndpointIdentity Parameter -
				code.AppendLine(string.Format("\t\tpublic static {2}Proxy Create{0}Service<TCallback>({3}{1}) where TCallback : class, new()", o.Parent.Name, certificateidentity, DataTypeGenerator.GenerateType(o.Parent.Service.HasClientType ? o.Parent.Service.ClientType : o.Parent.Service), IsDCMEnabled ? "Guid ClientID" : ""));
				code.AppendLine("\t\t{");
				ahlist = "";
				for (int i = 0; i < o.ClientAddressHeaders.Count; i++)
				{
				...
				code.AppendLine(string.Format("\t\tpublic static {2}Proxy Create{0}Service<TCallback>({3}string Address{1}) where TCallback : class, new()", o.Parent.Name, certificateidentity, DataTypeGenerator.GenerateType(o.Parent.Service.HasClientType ? o.Parent.Service.ClientType : o.Parent.Service), IsDCMEnabled ? "Guid ClientID, " : ""));
				code.AppendLine("\t\t{");
				ahlist = "";
				for (int i = 0; i < o.ClientAddressHeaders.Count; i++)
				{
				...
				code.AppendLine(string.Format("\t\tpublic static {2}Proxy Create{0}Service<TCallback>({3}int Port{1}) where TCallback : class, new()", o.Parent.Name, certificateidentity, DataTypeGenerator.GenerateType(o.Parent.Service.HasClientType ? o.Parent.Service.ClientType : o.Parent.Service), IsDCMEnabled ? "Guid ClientID, " : ""));
				code.AppendLine("\t\t{");
				ahlist = "";
				for (int i = 0; i < o.ClientAddressHeaders.Count; i++)
				{
				...
				code.AppendLine(string.Format("\t\tpublic static {2}Proxy Create{0}Service<TCallback>({3}string Address, int Port{1}) where TCallback : class, new()", o.Parent.Name, certificateidentity, DataTypeGenerator.GenerateType(o.Parent.Service.HasClientType ? o.Parent.Service.ClientType : o.Parent.Service), IsDCMEnabled ? "Guid ClientID, " : ""));
				code.AppendLine("\t\t{");
				ahlist = "";
				for (int i = 0; i < o.ClientAddressHeaders.Count; i++)
				{
				...
				code.AppendLine(string.Format("\t\tpublic static {1}Proxy Create{0}Service<TCallback>({2}int Port, System.ServiceModel.EndpointIdentity Identity) where TCallback : class, new()", o.Parent.Name, DataTypeGenerator.GenerateType(o.Parent.Service.HasClientType ? o.Parent.Service.ClientType : o.Parent.Service), IsDCMEnabled ? "Guid ClientID, " : ""));
				code.AppendLine("\t\t{");
				ahlist = "";
				for (int i = 0; i < o.ClientAddressHeaders.Count; i++)
				{
				...
				code.AppendLine(string.Format("\t\tpublic static {1}Proxy Create{0}Service<TCallback>({2}string Address, int Port, System.ServiceModel.EndpointIdentity Identity) where TCallback : class, new()", o.Parent.Name, DataTypeGenerator.GenerateType(o.Parent.Service.HasClientType ? o.Parent.Service.ClientType : o.Parent.Service), IsDCMEnabled ? "Guid ClientID, " : ""));
				code.AppendLine("\t\t{");
				ahlist = "";
				for (int i = 0; i < o.ClientAddressHeaders.Count; i++)
				{
				...
				#region - Generate Endpoint Functions WITHOUT EndpointIdentity Parameter -
				code.AppendLine(string.Format("\t\tpublic static {2}Proxy Create{0}ServiceConfig<TCallback>({3}string EndpointConfig{1}) where TCallback : class, new()", o.Parent.Name, certificateidentity, DataTypeGenerator.GenerateType(o.Parent.Service.HasClientType ? o.Parent.Service.ClientType : o.Parent.Service), IsDCMEnabled ? "Guid ClientID, " : ""));
				code.AppendLine("\t\t{");
				ahlist = "";
				for (int i = 0; i < o.ClientAddressHeaders.Count; i++)
				{
				...
				code.AppendLine(string.Format("\t\tpublic static {1}Proxy Create{0}ServiceConfig<TCallback>({2}string EndpointConfig, int Port, System.ServiceModel.EndpointIdentity Identity) where TCallback : class, new()", o.Parent.Name, DataTypeGenerator.GenerateType(o.Parent.Service.HasClientType ? o.Parent.Service.ClientType : o.Parent.Service), IsDCMEnabled ? "Guid ClientID, " : ""));
				code.AppendLine("\t\t{");
				ahlist = "";
				for (int i = 0; i < o.ClientAddressHeaders.Count; i++)
				{
				...
				code.AppendLine(string.Format("\t\tpublic static {1}Proxy Create{0}ServiceConfig<TCallback>({2}string EndpointConfig, string Address, int Port, System.ServiceModel.EndpointIdentity Identity) where TCallback : class, new()", o.Parent.Name, DataTypeGenerator.GenerateType(o.Parent.Service.HasClientType ? o.Parent.Service.ClientType : o.Parent.Service), IsDCMEnabled ? "Guid ClientID, " : ""));
				code.AppendLine("\t\t{");
				ahlist = "";
				for (int i = 0; i < o.ClientAddressHeaders.Count; i++)
				{

...
namespace NETPath.Generators.NET.CS
{
	internal static class DataGenerator
	{
		...
		private static string GenerateElementDCMProxyCode45(DataElement o, ref int ProtoCount, bool IsOverride = false)
		{
			...
			if (o.DataType.TypeMode == DataTypeMode.Collection)
			{
				code.AppendLine(string.Format("\t\tpublic static readonly DeltaProperty<DeltaList<{2}>> {0}Property = DeltaProperty<DeltaList<{2}>>.RegisterList<{2}>(\"{0}\", typeof({1}), (s, o, n) => {{ var t = s as {1}; if (t == null) return;", o.HasClientType ? o.ClientName : o.DataName, o.Owner.HasClientType ? o.Owner.ClientType.Name : o.Owner.Name, DataTypeGenerator.GenerateType(o.DataType.CollectionGenericType)));
